#Aprendendo a usar dados da educacao publica
...
unzip("censo_escolar_2021.zip", files = "microdados_ed_basica_2021/dados/microdados_ed_basica_2021.csv")

#lê o arquivo csv que estava no arquivo zip e alimenta o dataframe

microdados_ed_basica_2021 <- read_delim("microdados_ed_basica_2021/dados/microdados_ed_basica_2021.csv",
